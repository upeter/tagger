...
private:
    ...
    static const int TEAM_COLOR_END = 47; //43
    static const int HEALTH_START = 48; //44
    static const int HEALTH_END = 54; //50
    static const int AMMUNITION_START = 59; //55
    static const int AMMUNITION_END = 65; //61
